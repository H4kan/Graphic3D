...
namespace MysteryProject
{
    public class MatrixProvider
    {
        ...
        public Matrix4x4 ViewMatrix(Vector3 eye, Vector3 center, Vector3 up)
        {
        ...
        public Matrix4x4 ViewNormal(Vector3 eye, Vector3 center, Vector3 up)
        {
            Matrix4x4 viewModel = Matrix4x4.Identity;
            Vector3 z = Vector3.Normalize(eye -new Vector3(-center.X, center.Y, center.Z));
            Vector3 x = Vector3.Normalize(Vector3.Cross(up, z));
            Vector3 y = Vector3.Normalize(Vector3.Cross(z, x));
        ...
        public Matrix4x4 ModelMatrix(Vector3 eye, Vector3 center, Vector3 up)
        {
            Matrix4x4 viewModel = Matrix4x4.Identity;
            //Vector3 z = Vector3.Normalize(eye - center);
            //Vector3 x = Vector3.Normalize(Vector3.Cross(up, z));
